     ...
     <div className=" Footer py-5 px-4 ">
       <div className="row w-100 px-5">
        <div className="col-xl-3 mt-4 mt-sm-4 col-md-6 mb-3">
            <h2 className='mb-4'>Black Store</h2>
            <p className='text-white mb-5'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore saepe maxime iusto magni assumenda sunt, harum, nemo laudantium repellat ullam dicta quasi ad neque ut cumque asperiores dignissimos in tenetur.</p>
        ...
        <div className="col-xl-3   mt-4 mt-sm-4 col-md-6">
            <h2>Contact Us</h2>
            <ul>
                <li >  <p className='text-white fs-5 fw-lighter'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Exercitationem nobis voluptate accusamus, dolorum ut facilis, </p></li>
                <li > Email:ahmedrabie22@gmail.com</li>
                <li >   Phone: 01226545067</li>
              </ul>
        </div>
       </div>
     </div>
